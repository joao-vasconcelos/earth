    ...
    <main>
      <section className={styles.flippedClassroom}>
        ...
        <container className={styles.info}>
          ...
          <a className={styles.download} href="https://perennial.joao.earth/earth/isa/saaft/fc3/saaft-fc3-silvopasture-in-the-caatinga-biome-of-brazil.pdf" target="_blank" rel="noreferrer" download>
            ⬇︎ Download Article
          </a>
        </container>
        ...
        <container className={styles.info}>
          ...
          <a className={styles.download} href="https://perennial.joao.earth/earth/isa/saaft/fc3/saaft-fc3-microclimate-and-soil-moisture-in-a-silvopastoral-system-in-southeastern-brazil.pdf" target="_blank" rel="noreferrer" download>
            ⬇︎ Download Article
          </a>
        </container>
      </section>
