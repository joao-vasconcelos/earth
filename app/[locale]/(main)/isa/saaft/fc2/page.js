    ...
    <main>
      <section className={styles.flippedClassroom}>
        ...
        <container className={styles.info}>
          ...
          <a className={styles.download} href="https://perennial.joao.earth/earth/isa/saaft/fc2/saaft-fc2-multi-level-socioecological-drivers-of-agrarian-change.pdf" target="_blank" rel="noreferrer" download>
            ⬇︎ Download Article
          </a>
        </container>
        ...
        <container className={styles.info}>
          ...
          <a className={styles.download} href="https://perennial.joao.earth/earth/isa/saaft/fc2/saaft-fc2-cultivating-the-dry-forests-of-south-america.pdf" target="_blank" rel="noreferrer" download>
            ⬇︎ Download Article
          </a>
        </container>
      </section>
