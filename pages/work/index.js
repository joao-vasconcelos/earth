    ...
    <main>
      <Intro>
        <Container>
          ...
          <h3>Jonathan Ive</h3>
          <p>
            Building better tools is what wakes me up in the morning. It all starts by defining the problem to be solved and thinking about it from the user&apos;s perspective. Only by focusing hard on this approach is it possible to be confident in
            one&apos;s decisions. The following examples combine design, technology, and a lot of dedication to create intuitive tools that simplify its users&apos; lives.
          </p>
        </Container>
      </Intro>
